...
public class EinkaufszettelController {
  ...
  @DeleteMapping("{id}")
  public ResponseEntity<Einkaufszettel> deleteEinkaufszettel(@PathVariable Long id) {
    return ResponseEntity.ok(einkaufszettelService.deleteEinkaufszettel(id));
  }
  ...
  public ResponseEntity<Artikel> deleteArtikel(@PathVariable Long id) {
    return ResponseEntity.ok(einkaufszettelService.deleteArtikel(id));
  }
